...
sf.write(os.path.join(output_dir, "decoded_single_12hz.wav"), wavs1[0], out_sr1)
...
for i, w in enumerate(wavs2):
    sf.write(os.path.join(output_dir, f"decoded_batch_12hz_{i}.wav"), w, out_sr2)
...
sf.write(os.path.join(output_dir, "decoded_dict_12hz.wav"), wavs_d1[0], out_sr_d1)
...
for i, w in enumerate(wavs_d2):
    sf.write(os.path.join(output_dir, f"decoded_listdict_12hz_{i}.wav"), w, out_sr_d2)
...
for i, w in enumerate(wavs_d3):
    sf.write(os.path.join(output_dir, f"decoded_listdict_numpy_12hz_{i}.wav"), w, out_sr_d3)
...
sf.write(os.path.join(output_dir, "decoded_numpy_12hz.wav"), wavs3[0], out_sr3)